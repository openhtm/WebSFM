...
public:
  ...
  */
  ...
  void serialize(const Eigen::Matrix4d&, SerializedPose*);
  ...
  */
  ...
  void deserialize(const SerializedPose&, Eigen::Matrix4d&);
  ...
  */
  ...
  void serialize(const Eigen::Vector3d&, SerializedPosition*);
  ...
  */
  ...
  void deserialize(const SerializedPosition&, Eigen::Vector3d&);
