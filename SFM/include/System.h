...
class System {
 public:
  System(const std::string& voc_file, const std::string& string_setting_file);

  System(const std::string& voc_file, const int imwidth, const int imheight, const std::string& keyframe_dir);
...
//  private:
  ...
  const std::string keyframe_dir_;
};
